...
*   [Setting Up Our Project's Environment](https://gitlab.cs.usu.edu/jaxtonw/sp22-discord-bot-draft/-/blob/master/doc/LectureNotes.md#setting-up-our-projects-environment)
    *   [Managing Dependencies With `requirements.txt`](https://gitlab.cs.usu.edu/jaxtonw/sp22-discord-bot-draft/-/blob/master/doc/LectureNotes.md#setting-up-our-projects-environment)
*   [Virutal Environment](https://gitlab.cs.usu.edu/jaxtonw/sp22-discord-bot-draft/-/blob/master/doc/LectureNotes.md#virtual-environment)
    *   [Virtual Environment Setup Commands](https://gitlab.cs.usu.edu/jaxtonw/sp22-discord-bot-draft/-/blob/master/doc/LectureNotes.md#virtual-environment-setup-commands)
    *   [Inside the Virtual Environment](https://gitlab.cs.usu.edu/jaxtonw/sp22-discord-bot-draft/-/blob/master/doc/LectureNotes.md#inside-the-virutal-environment)
*   [Choose A License](https://gitlab.cs.usu.edu/jaxtonw/sp22-discord-bot-draft/-/blob/master/doc/LectureNotes.md#choose-a-license)
*   [Initial Setup of `main.py`](https://gitlab.cs.usu.edu/jaxtonw/sp22-discord-bot-draft/-/blob/master/doc/LectureNotes.md#initial-setup-of-mainpy)
    *   [Neccessary Imports](https://gitlab.cs.usu.edu/jaxtonw/sp22-discord-bot-draft/-/blob/master/doc/LectureNotes.md#necessary-imports)
    *   [Discord's `Intents`](https://gitlab.cs.usu.edu/jaxtonw/sp22-discord-bot-draft/-/blob/master/doc/LectureNotes.md#discords-intents)
    *   [Client Object](https://gitlab.cs.usu.edu/jaxtonw/sp22-discord-bot-draft/-/blob/master/doc/LectureNotes.md#client-object)
*   [Getting Your Discord API Token](https://gitlab.cs.usu.edu/jaxtonw/sp22-discord-bot-draft/-/blob/master/doc/LectureNotes.md#getting-your-discord-client-api-token)
    *   [Create an Application](https://gitlab.cs.usu.edu/jaxtonw/sp22-discord-bot-draft/-/blob/master/doc/LectureNotes.md#create-an-application)
    *   [Invite the Bot to a Server](https://gitlab.cs.usu.edu/jaxtonw/sp22-discord-bot-draft/-/blob/master/doc/LectureNotes.md#invite-the-bot-to-a-server)
    *   [Copying the Bot's API Key](https://gitlab.cs.usu.edu/jaxtonw/sp22-discord-bot-draft/-/blob/master/doc/LectureNotes.md#copying-the-bots-api-key)
*   [Connecting Your Discord Client](https://gitlab.cs.usu.edu/jaxtonw/sp22-discord-bot-draft/-/blob/master/doc/LectureNotes.md#connecting-your-discord-client)
    *   [Protecting Your API Key](https://gitlab.cs.usu.edu/jaxtonw/sp22-discord-bot-draft/-/blob/master/doc/LectureNotes.md#connecting-your-discord-client)
        *   [`.env` files](https://gitlab.cs.usu.edu/jaxtonw/sp22-discord-bot-draft/-/blob/master/doc/LectureNotes.md#connecting-your-discord-client)   
        *   [Loading `.env` files with `python-dotenv`](https://gitlab.cs.usu.edu/jaxtonw/sp22-discord-bot-draft/-/blob/master/doc/LectureNotes.md#connecting-your-discord-client)
*   [Discord Client Events](https://gitlab.cs.usu.edu/jaxtonw/sp22-discord-bot-draft/-/blob/master/doc/LectureNotes.md#connecting-your-discord-client)
    *   [`on_ready`](https://gitlab.cs.usu.edu/jaxtonw/sp22-discord-bot-draft/-/blob/master/doc/LectureNotes.md#connecting-your-discord-client)
    *   [`on_message`](https://gitlab.cs.usu.edu/jaxtonw/sp22-discord-bot-draft/-/blob/master/doc/LectureNotes.md#connecting-your-discord-client)
*   [Discord `commands.Bot` Client Subclass](https://gitlab.cs.usu.edu/jaxtonw/sp22-discord-bot-draft/-/blob/master/doc/LectureNotes.md#connecting-your-discord-client)
    *   [`commands.Bot` Default Help Command](https://gitlab.cs.usu.edu/jaxtonw/sp22-discord-bot-draft/-/blob/master/doc/LectureNotes.md#connecting-your-discord-client)
    *   [`on_message` Event With `commands.Bot` class](https://gitlab.cs.usu.edu/jaxtonw/sp22-discord-bot-draft/-/blob/master/doc/LectureNotes.md#connecting-your-discord-client)

# Draft Repo for Sp22 Discord Bot Presentation

## Table Of Contents

*   The doc/LectureNotes.md file contains information about all the topics covered in this presentation:
*   [Setting Up Our Project's Environment](https://gitlab.cs.usu.edu/jaxtonw/sp22-discord-bot-draft/-/blob/master/doc/LectureNotes.md#setting-up-our-projects-environment)
    *   [Managing Dependencies With `requirements.txt`](https://gitlab.cs.usu.edu/jaxtonw/sp22-discord-bot-draft/-/blob/master/doc/LectureNotes.md#setting-up-our-projects-environment)
*   [Virutal Environment](https://gitlab.cs.usu.edu/jaxtonw/sp22-discord-bot-draft/-/blob/master/doc/LectureNotes.md#virtual-environment)
    *   [Virtual Environment Setup Commands](https://gitlab.cs.usu.edu/jaxtonw/sp22-discord-bot-draft/-/blob/master/doc/LectureNotes.md#virtual-environment-setup-commands)
